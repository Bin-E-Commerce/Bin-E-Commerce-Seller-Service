...
import { SellerApplication } from "../../seller-onboarding/entities/seller-application.entity";
...
export class Shop {
  ...
  // Counter được cập nhật cùng transaction với quan hệ follow để header shop đọc nhanh và không phải COUNT mỗi request.
  @Column({ name: "follower_count", type: "int", default: 0 })
  followerCount: number;

  // Số shop mà chủ shop đang theo dõi; đây là chỉ số của owner, không phải số người theo dõi shop hiện tại.
