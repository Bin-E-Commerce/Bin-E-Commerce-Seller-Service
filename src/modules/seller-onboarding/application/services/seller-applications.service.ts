...
import { ListSellerApplicationsQueryDto } from '@/modules/seller-onboarding/presentation/dto/list-seller-applications-query.dto';
import { ListSellerApplicationsResponseDto } from '@/modules/seller-onboarding/presentation/dto/list-seller-applications-response.dto';
import { RejectSellerApplicationDto } from '@/modules/seller-onboarding/presentation/dto/reject-seller-application.dto';
import { SaveSellerApplicationDto } from '@/modules/seller-onboarding/presentation/dto/save-seller-application.dto';
import { SellerApplicationResponseDto } from '@/modules/seller-onboarding/presentation/dto/seller-application-response.dto';
import { CurrentUserContext } from '@/modules/seller-onboarding/application/types/current-user-context.type';
import { SellerApplicationAuthService } from '@/modules/seller-onboarding/application/services/seller-application-auth.service';
import { SellerApplicationEventsService } from '@/modules/seller-onboarding/application/services/seller-application-events.service';
import { SellerApplicationMapper } from '@/modules/seller-onboarding/application/services/seller-application.mapper';
import { SellerApplicationValidatorService } from '@/modules/seller-onboarding/application/services/seller-application-validator.service';
import { SellerApplicationCorrectionService } from '@/modules/seller-onboarding/application/services/seller-application-correction.service';
import {
    mapApprovedApplicationToComplianceProfile,
    mapApprovedApplicationToShop,
} from '@/modules/shop-profile/application/utils/shop-provisioning.util';
    ...
    async listForAdmin(
        ...
        return {
            items: items.map((application) =>
                this.mapper.toResponse(application),
            ),
            meta: {
                page,
                pageSize,
    ...
    async rejectForAdmin(
        ...
        const rejected = await this.applicationRepository.manager.transaction(
            async (manager) => {
                ...
                if (
                    application.status !==
                    SellerApplicationStatus.PENDING_REVIEW
                ) {
            ...
            async (manager) => {
                ...
                if (!existingShop) {
                    ...
                    const existingCompliance =
                        await complianceRepository.findOne({
    ...
    async resubmit(
        ...
        const result = await this.applicationRepository.update(
            ...
            },
            {
                ...
                pickupGhnProvinceId: application.pickupGhnProvinceId,
                pickupGhnProvinceName: application.pickupGhnProvinceName,
                pickupGhnDistrictId: application.pickupGhnDistrictId,
                pickupGhnDistrictName: application.pickupGhnDistrictName,
                pickupGhnWardCode: application.pickupGhnWardCode,
                pickupGhnWardName: application.pickupGhnWardName,
