...
import { toNullableString } from '@/modules/seller-onboarding/application/utils/seller-application-string.util';
...
export class SellerApplicationMapper {
    ...
    applyDto(
        ...
        if (dto.shop) {
            ...
            application.mainCategoryId = toNullableString(
                dto.shop.mainCategoryId,
            );
            application.businessModel = toNullableString(
                dto.shop.businessModel,
            );
            application.shopDescription = toNullableString(
                dto.shop.description,
            );
        ...
        if (dto.pickupAddress) {
            ...
            application.pickupGhnProvinceId =
                dto.pickupAddress.provinceId ?? null;
            application.pickupGhnProvinceName = toNullableString(
                dto.pickupAddress.provinceName,
            );
            application.pickupGhnDistrictId =
                dto.pickupAddress.districtId ?? null;
