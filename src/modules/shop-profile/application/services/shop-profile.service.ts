...
import { ShopProfileResponseDto } from '@/modules/shop-profile/presentation/dto/shop-profile-response.dto';
import { UpdateShopProfileDto } from '@/modules/shop-profile/presentation/dto/update-shop-profile.dto';
        ...
        return {
            capabilities: {
                ...
                canRequestSensitiveChange:
                    this.access.canCreateChangeRequest(user) &&
            ...
            identity: {
                ...
                documentTypes: Object.keys(
                    compliance.verificationDocuments ?? {},
                ),
    ...
    async updateMine(
        ...
        if (Object.keys(normalizedPatch).length === 0) {
            throw new BadRequestException(
                'Không có thông tin shop nào để cập nhật.',
            );
        }
