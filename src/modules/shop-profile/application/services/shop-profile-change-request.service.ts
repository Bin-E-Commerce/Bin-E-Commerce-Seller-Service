...
import {
    ...
    ShopPayoutChangeDto,
    ShopTaxChangeDto,
} from '@/modules/shop-profile/presentation/dto/create-shop-profile-change-request.dto';
import { ListShopProfileChangeRequestsQueryDto } from '@/modules/shop-profile/presentation/dto/list-shop-profile-change-requests-query.dto';
import {
    ApproveShopProfileChangeRequestDto,
    RejectShopProfileChangeRequestDto,
} from '@/modules/shop-profile/presentation/dto/review-shop-profile-change-request.dto';
import {
    ListShopProfileChangeRequestsResponseDto,
    ShopProfileChangeRequestResponseDto,
} from '@/modules/shop-profile/presentation/dto/shop-profile-change-request-response.dto';
import {
    ShopProfileCurrentSnapshot,
    ShopProfileRequestedChanges,
} from '@/modules/shop-profile/application/types/shop-profile-change.type';
import { ShopUserContext } from '@/modules/shop-profile/application/types/shop-user-context.type';
...
export class ShopProfileChangeRequestService {
    ...
    async createMine(
        ...
        const createdId = await this.dataSource.transaction(async (manager) => {
            ...
            const requestedChanges = this.normalizeEffectiveChanges(
                dto,
                compliance,
            );
            ...
            this.assertIdentityDocuments(
                requestedChanges,
                compliance.profileType,
            );
    ...
    private toResponse(
        ...
        return {
            ...
            currentSnapshot:
                request.currentSnapshot as ShopProfileCurrentSnapshot,
            requestedChanges:
                request.requestedChanges as ShopProfileRequestedChanges,
